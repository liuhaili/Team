...
namespace Lemon
{
    ...
    public static class SqlConverter
    {
        ...
        private static Dictionary<string, string> getFieldsAndValues(object tObj)
        {
            ...
            {
                if (Attribute.GetCustomAttributes(propertyInfo, true).Any(c => c.GetType() == typeof(NotDataField)))
                    continue;
                ...
                //对于字符和datetime，要加上引号
                if (propertyType == typeof(System.Boolean) || propertyType == typeof(System.String) || propertyType == typeof(System.DateTime) || propertyType == typeof(System.DateTime?) || propertyType.IsEnum)
                {
